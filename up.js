...
//━━━━━━━━━━━━━━━[ HARI HARI ]━━━━━━━━━━━━━━━\\
        ...
        const isUrl = (url) => {
			...
			const reply = (teks) => {
			client.sendMessage(from, teks, text, { thumbnail: gember, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `${jmn} WIB - ${week}`,body:"MyZenix",previewType:"PHOTO",thumbnail:gember,sourceUrl:`https://wa.me/p/6349482305092740/6285697662826`}}})
		}
		const reply2 = (teks) => {
...
//━━━━━━━━━━━━━━━[ FAKE FAKEAN ]━━━━━━━━━━━━━━━\\
           ...
           const fakedoc = {key: {fromMe: false, participant: `${nomorowner}@s.whatsapp.net`, ...(from ? {remoteJid: "status@broadcast" } : {}) }, message: {documentMessage: {mimetype: 'application/octet-stream', title: `${ucapanFakereply}`, pageCount: 0, fileName: `MyZenix`, jpegThumbnail: fs.readFileSync(`./img/thumb.jpg`)}}}
...
if (isBanned) return reply(mess.banned)
 if(menugif== true){
 listMsg = {
 buttonText: 'MyZenix404',
 footerText: `Hai Kak ${pushname}👋,${ucapanWaktu}
  
  *_Info Bot_*
  
  Nama Bot : ${namabot}
  Owner : wa.me/6283876159184
  Prefix : [ MULTI]
...
Bot Masih Dalam Pembuatan,Jika Ada Bug Silahkan Hubungi Owner`,
...
client.sendMessage(from, listMsg, MessageType.listMessage, {contextInfo: { mentionedJid: [sender]},quoted:ftrol})
              }else if(menugif == false){  
owner7 = "6283876159184@s.whatsapp.net"
anu =`
...
`
sendButLocation(from, anu,`Bot Masih Dalam Proses,Jika Ada Fitur Yang Eror Silahkan Hubungi Owner\n${Tanggal}`, thumb, [
          ...
          const hyj = await getBuffer(`https://telegra.ph/file/f5efe3ba759ad0c9077bf.mp4`)
             buttons = [{buttonId: `${prefix}owner`,buttonText:{displayText: `MENU`},type:1}]
...
🔖 *_${prefix}neondevil {teks}_*
🔖 *_${prefix}underwater {teks}_*
🔖 *_${prefix}bear {teks}_*`, videoMessage: videoMsg,
              contentText:`MyZenix`,buttons,headerType:5}
...
client.sendMessage(from, mp3, audio)
break
case 'ytmp3':
if (isBanned) return reply(mess.banned)
reply(mess.wait)
...
anu =`Silahkan pilih salah satu di bawah`
 buttons = [{buttonId: '.setmenu vid', buttonText: {displayText: 'VIDEO'}, type: 1},{buttonId: '.setmenu lokasi', buttonText: {displayText: 'LOKASI'}, type: 1},{buttonId: '.setmenu simpel', buttonText: {displayText: 'SIMPLE'}, type: 1}]
const skuygelud = {
    contentText: `${anu}`,
    footerText: 'Zenixx',
    buttons: buttons,
